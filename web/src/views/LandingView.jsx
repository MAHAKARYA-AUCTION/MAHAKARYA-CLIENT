  ...
  return (
    <div className="flex flex-col justify-between h-min-screen">
      ...
      <div className="space-y-5">
        ...
        {/* END:TITLE */}
        {/* START:MENU */}
        <div class="navbar sticky top-0 z-50 bg-[#ebd7bb]">
          <div class="navbar-start"></div>
          <div class="navbar-center hidden lg:flex">
            <ul class="menu-horizontal p-0 poppins text-xl font-semibold space-x-4">
              <li>
                <button className="x-6 py-3 poppins font-semibold mr-2 hover:scale-110 transform transition duration-400">
                  Menu 1
                </button>
          ...
          <div class="carousel w-full">
            <div id="slide1" class="carousel-item relative w-full">
              ...
              <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a
                  href="#slide3"
                  class="btn btn-circle bg-[#57240f] hover:bg-[#cdbba6] text-[#cdbba6] hover:text-[#57240f] hover:scale-105 transform transition duration-400 border-0"
                >
                  ❮
                </a>
                <a
