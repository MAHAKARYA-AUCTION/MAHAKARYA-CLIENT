    ...
    <>
      <a-scene>
        ...
        <a-text
          id="Uppsala Tower"
          value="UPPSALA TOWER"
          position="2.5 3.1 -5.7"
          color="white"
          scale=".5 .5 .5"
        ></a-text>
        <a-text
          id="Floor 1"
          value="Floor 1  : LaundFazz Office"
          position="2.5 2.9 -5.7"
          color="white"
          scale=".5 .5 .5"
        ></a-text>
        <a-text
          id="Floor 2"
          value="Floor 2  : Palms Ballroom Office"
          position="2.5 2.7 -5.7"
          color="white"
          scale=".5 .5 .5"
        ></a-text>
        <a-text
          id="Floor 3"
          value="Floor 3  : GoMank Office"
          position="2.5 2.5 -5.7"
          color="white"
          scale=".5 .5 .5"
        ></a-text>
        <a-text
          id="Floor 4"
          value="Floor 4  : NuerPay Office"
          position="2.5 2.3 -5.7"
          color="white"
          scale=".5 .5 .5"
        ></a-text>
        <a-text
          id="Floor 5"
          value="Floor 5  : Mahakarya Goliath Gallery"
        ...
        <a-text
          id="Floor 6"
          value="Floor 6  : Mahakarya David Gallery"
          position="2.5 1.9 -5.7"
          color="white"
          scale=".5 .5 .5"
        ></a-text>
